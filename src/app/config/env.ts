...
const loadEnvVariables = (): EnvConfig => {
    ...
    const requiredEnvVariables: string[] = ["PORT", "DB_URL", "NODE_ENV", "BCRYPT_SALT_ROUND", "JWT_ACCESS_EXPIRES", "JWT_ACCESS_SECRET","OTP_JWT_ACCESS_SECRET", "OTP_JWT_ACCESS_EXPIRATION", "SUPER_ADMIN_EMAIL", "SUPER_ADMIN_PASSWORD", "JWT_REFRESH_SECRET", "JWT_REFRESH_EXPIRES", "GOOGLE_CLIENT_SECRET", "GOOGLE_CLIENT_ID", "GOOGLE_CALLBACK_URL", "GOOGLE_ANDROID_CLIENT_ID", "GOOGLE_IOS_CLIENT_ID", "EXPRESS_SESSION_SECRET", "FRONTEND_URL", "SSL_STORE_ID",
        "SSL_STORE_PASS",
